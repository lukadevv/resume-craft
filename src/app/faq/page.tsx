...
export const metadata: Metadata = {
  title: 'FAQ - ResumeCraft',
  description:
    'Frequently asked questions about ResumeCraft — privacy, exporting, templates, offline usage, and more.',
  keywords: ['FAQ', 'resume builder help', 'frequently asked questions', 'how to use'],
  openGraph: {
    title: 'FAQ - ResumeCraft',
    description:
      'Frequently asked questions about ResumeCraft — privacy, exporting, templates, and more.',
    type: 'website',
  },
  alternates: {
    canonical: '/faq',
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-lg text-foreground-secondary md:text-xl">
                  Everything you need to know about using ResumeCraft — from
                  privacy to exporting and everything in between.
                </p>
              </div>
            </div>
          </section>
