...
export const metadata: Metadata = {
  ...
  description:
    'How ResumeCraft handles your data. We respect your privacy and are transparent about what we collect and why.',
  keywords: [
    'privacy policy',
    'data privacy',
  ...
  openGraph: {
    title: 'Privacy Policy - ResumeCraft',
    description: 'How ResumeCraft handles your data. We respect your privacy.',
    type: 'website',
  },
  alternates: {
    canonical: '/privacy',
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-lg text-foreground-secondary md:text-xl">
                  We believe in radical transparency. Here&apos;s exactly how
                  ResumeCraft handles your data — spoiler: it barely leaves your
                  device.
                </p>
