...
export const metadata: Metadata = {
  ...
  description:
    'Terms and conditions for using ResumeCraft. Understand your rights and responsibilities when using our resume builder.',
  keywords: [
    'terms of service',
    'terms of use',
  ...
  openGraph: {
    title: 'Terms of Service - ResumeCraft',
    description:
      'Terms and conditions for using ResumeCraft. Understand your rights and responsibilities.',
    type: 'website',
  },
  alternates: {
    canonical: '/terms',
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-lg text-foreground-secondary md:text-xl">
                  These terms govern your use of ResumeCraft. We&apos;ve kept
                  them straightforward — no hidden clauses, no surprises.
                </p>
