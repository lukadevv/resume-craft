...
export const metadata: Metadata = {
  title: 'Accessibility - ResumeCraft',
  description:
    'ResumeCraft is committed to making resume creation accessible to everyone. Learn about our accessibility features and standards.',
  keywords: [
    'accessibility',
    'a11y',
    'WCAG',
  ...
  openGraph: {
    title: 'Accessibility - ResumeCraft',
    description:
      'ResumeCraft is committed to making resume creation accessible to everyone.',
    type: 'website',
  },
  alternates: {
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <p className="mt-4 text-lg text-foreground-secondary md:text-xl">
                  We believe creating a professional resume should not be a
                  barrier for anyone. Here&apos;s how we&apos;re making
                  ResumeCraft accessible.
                </p>
              </div>
            </div>
          </section>
