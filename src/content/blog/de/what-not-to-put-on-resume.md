---
title: "Was Sie 2026 NICHT in Ihren Lebenslauf schreiben sollten"
slug: what-not-to-put-on-resume
excerpt: "Einige Lebenslaufkonventionen sind veraltet, platzverschwendend oder schaden aktiv Ihren Chancen. Hier sind 8 Dinge, die Sie jetzt löschen sollten."
date: '2026-06-12'
...
1. Vollständige Straßenadresse → Nur Stadt und Bundesland
2. „Referenzen auf Anfrage" → Die Zeile komplett löschen
3. Zielformulierung → Durch berufliche Zusammenfassung ersetzen
4. Generische Hobbys → Streichen oder relevant machen
5. Foto (USA/Kanada) → Entfernen, es sei denn ausdrücklich verlangt
6. Gehaltsinformationen → Für die Verhandlungsphase aufheben
7. Veraltete technische Fähigkeiten → Nur aktuelle, relevante Fähigkeiten behalten
8. „Ich" und „Mein" in Aufzählungspunkten → Jeden Punkt mit einem Verb beginnen
