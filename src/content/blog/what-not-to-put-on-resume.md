---
title: "What NOT to Put on Your Resume in 2026"
slug: what-not-to-put-on-resume
excerpt: "Some resume conventions are outdated, wasteful, or actively hurting your chances. Here are 8 things to delete right now."
date: '2026-06-12'
...
1. Full street address → City and state only
2. "References available upon request" → Delete the line entirely
3. Objective statement → Replace with professional summary
4. Generic hobbies → Cut or make them relevant
5. Photo (US/Canada) → Remove unless explicitly requested
6. Salary information → Leave for the negotiation phase
7. Outdated technical skills → Keep only current, relevant skills
8. "I" and "My" in bullet points → Start every bullet with a verb
