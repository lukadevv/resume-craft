...
export const templateDefinitions: TemplateDefinition[] = [
  ...
  // 2. Data Scientist
  {
    ...
    accentColor: '#0ea5e9',
    primarySections: ['summary', 'workExperience', 'projects'],
    sidebarSections: ['skills', 'tools', 'certifications', 'education'],
  ...
  // 4. Graphic Designer
  {
    ...
    accentColor: '#f43f5e',
    primarySections: ['summary', 'workExperience', 'projects', 'portfolio'],
    sidebarSections: ['skills', 'tools', 'awards', 'education'],
    emphasisComponents: ['backgroundAccent', 'skillDots'],
    background: {
  ...
  // 5. Product Manager
  {
    ...
    layoutType: 'two-column',
    accentColor: '#6366f1',
    primarySections: ['summary', 'workExperience', 'coreCompetencies'],
    sidebarSections: ['skills', 'tools', 'certifications', 'education'],
  ...
  // 9. Accountant
  {
    ...
    layoutType: 'two-column',
    accentColor: '#64748b',
    primarySections: ['summary', 'workExperience', 'certifications'],
    sidebarSections: ['skills', 'tools', 'education', 'affiliations'],
  ...
  // 10. Nurse / Healthcare
  {
    ...
    layoutType: 'two-column',
    accentColor: '#22c55e',
    primarySections: ['summary', 'workExperience', 'clinicalSkills'],
    sidebarSections: ['licenses', 'certifications', 'skills', 'education'],
  ...
  // 11. Teacher / Educator
  {
    ...
    layoutType: 'two-column',
    accentColor: '#0d9488',
    primarySections: ['summary', 'workExperience', 'classroomExperience'],
    sidebarSections: ['certifications', 'skills', 'education', 'teachingPhilosophy'],
  ...
  // 13. Lawyer / Attorney
  {
    ...
    layoutType: 'two-column',
    accentColor: '#1e293b',
    primarySections: ['summary', 'workExperience', 'practiceAreas'],
    sidebarSections: ['barAdmission', 'education', 'skills', 'affiliations'],
    emphasisComponents: ['certificationBadge'],
    background: {
  ...
  // 15. Executive / C-Level
  {
    ...
    accentColor: '#0f172a',
    primarySections: ['summary', 'workExperience', 'coreCompetencies'],
    sidebarSections: ['education', 'affiliations', 'certifications'],
    emphasisComponents: ['metricsCallout', 'backgroundAccent'],
    background: {
  ...
  // 17. Management Consultant
  {
    ...
    accentColor: '#2563eb',
    primarySections: ['summary', 'workExperience', 'coreCompetencies'],
    sidebarSections: ['skills', 'tools', 'education', 'certifications'],
  ...
  // 19. Military-to-Civilian Transition
  {
    ...
    layoutType: 'two-column',
    accentColor: '#374151',
    primarySections: ['summary', 'workExperience', 'securityClearance'],
    sidebarSections: ['skills', 'certifications', 'education', 'achievements'],
